         ...
         <h1 >INVOICE</h1>
               <div className='grid-parent'>
                ...
                <div>
                           ...
                           <p className='flex-r'>Airtel No: <span> 2334444444</span></p>
                           <p className='flex-r'>shipment No:<span>23</span></p>
                           <p className='flex-r'>Bill No:<span>2</span></p>
                           <p className='flex-r'> Bill Date:<span>21/2/2002</span></p>
                ...
                <div className='c-10'>
                    <p>
                        <p>Airtel No:9089989877</p>
                        <p>Amount Due:300</p>
                        <p>For cheque/dd/pay order,payment should be in favour of "Airtel mobile No :232333433"</p>
                        <div>
